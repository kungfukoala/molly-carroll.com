...
;(function($) {
    ...
    defaults = {
        ...
        cloudmade_api_key: "336304a90a064433aee8146c4d6668f5",
        cloudmade_tile_set_id: 997,
        detect_retina: true
    };
    ...
    methods = {
        ...
        startMap: function() {
            ...
            settings.map.object = L.map(mapId, {
                scrollWheelZoom: settings.interaction.scroll_wheel_zoom,
                doubleClickZoom: settings.interaction.double_click_zoom,
                boxZoom: settings.interaction.box_zoom,
                touchZoom: settings.interaction.touch_zoom,
                dragging: settings.interaction.draggable
            ...
            L.tileLayer('http://{s}.tile.cloudmade.com/{key}/{styleId}/256/{z}/{x}/{y}.png', {
                ...
                key: settings.cloudmade_api_key,
                styleId: settings.cloudmade_tile_set_id,
                detectRetina: settings.detect_retina
            }).addTo(settings.map.object);
        ...
        showAddressLookup: function() {
            ...
            $("#modal-placement")
                ...
                .on("submit.location", "form", function() {
                    ...
                    $.getJSON(
                        "http://open.mapquestapi.com/geocoding/v1/address?callback=?",
                        {
                            location: address,
                            maxResults: 1,
                            thumbMaps: false
